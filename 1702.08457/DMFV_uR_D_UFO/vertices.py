...
V_82 = Vertex(name = 'V_82',
              particles = [ P.chi1__tilde__, P.u, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_17})

V_83 = Vertex(name = 'V_83',
              particles = [ P.chi2__tilde__, P.u, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_18})

V_84 = Vertex(name = 'V_84',
              particles = [ P.chi3__tilde__, P.u, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_19})

V_85 = Vertex(name = 'V_85',
              particles = [ P.chi1__tilde__, P.c, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_20})

V_86 = Vertex(name = 'V_86',
              particles = [ P.chi2__tilde__, P.c, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_21})

V_87 = Vertex(name = 'V_87',
              particles = [ P.chi3__tilde__, P.c, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_22})

V_88 = Vertex(name = 'V_88',
              particles = [ P.chi1__tilde__, P.t, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_23})

V_89 = Vertex(name = 'V_89',
              particles = [ P.chi2__tilde__, P.t, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_24})

V_90 = Vertex(name = 'V_90',
              particles = [ P.chi3__tilde__, P.t, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_25})

V_91 = Vertex(name = 'V_91',
              particles = [ P.c__tilde__, P.chi1, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_153})

V_92 = Vertex(name = 'V_92',
              particles = [ P.t__tilde__, P.chi1, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_156})

V_93 = Vertex(name = 'V_93',
              particles = [ P.u__tilde__, P.chi1, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_150})

V_94 = Vertex(name = 'V_94',
              particles = [ P.c__tilde__, P.chi2, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_154})

V_95 = Vertex(name = 'V_95',
              particles = [ P.t__tilde__, P.chi2, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_157})

V_96 = Vertex(name = 'V_96',
              particles = [ P.u__tilde__, P.chi2, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_151})

V_97 = Vertex(name = 'V_97',
              particles = [ P.c__tilde__, P.chi3, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_155})

V_98 = Vertex(name = 'V_98',
              particles = [ P.t__tilde__, P.chi3, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_158})

V_99 = Vertex(name = 'V_99',
              particles = [ P.u__tilde__, P.chi3, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
