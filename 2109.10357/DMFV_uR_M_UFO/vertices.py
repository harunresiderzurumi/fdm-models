...
V_82 = Vertex(name = 'V_82',
              particles = [ P.chi1, P.u, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_17})

V_83 = Vertex(name = 'V_83',
              particles = [ P.chi2, P.u, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_18})

V_84 = Vertex(name = 'V_84',
              particles = [ P.chi3, P.u, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_19})

V_85 = Vertex(name = 'V_85',
              particles = [ P.chi1, P.c, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_20})

V_86 = Vertex(name = 'V_86',
              particles = [ P.chi2, P.c, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_21})

V_87 = Vertex(name = 'V_87',
              particles = [ P.chi3, P.c, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_22})

V_88 = Vertex(name = 'V_88',
              particles = [ P.chi1, P.t, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_23})

V_89 = Vertex(name = 'V_89',
              particles = [ P.chi2, P.t, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_24})

V_90 = Vertex(name = 'V_90',
              particles = [ P.chi3, P.t, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
