...
V_7 = Vertex(name = 'V_7',
             particles = [ P.G0, P.G0, P.phi__tilde__, P.phi ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_26})

V_8 = Vertex(name = 'V_8',
             particles = [ P.G__minus__, P.G__plus__, P.phi__tilde__, P.phi ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_26})

V_9 = Vertex(name = 'V_9',
             particles = [ P.H, P.H, P.phi__tilde__, P.phi ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_26})

V_10 = Vertex(name = 'V_10',
              particles = [ P.phi__tilde__, P.phi__tilde__, P.phi, P.phi ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
...
V_14 = Vertex(name = 'V_14',
              particles = [ P.H, P.phi__tilde__, P.phi ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
...
V_46 = Vertex(name = 'V_46',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_134,(0,1):C.GC_133})
...
V_49 = Vertex(name = 'V_49',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_137,(0,1):C.GC_136})
...
V_67 = Vertex(name = 'V_67',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_88,(0,1):C.GC_81})
...
V_70 = Vertex(name = 'V_70',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_112,(0,1):C.GC_82})

V_71 = Vertex(name = 'V_71',
              particles = [ P.d__tilde__, P.t, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_110,(0,1):C.GC_93})
...
V_73 = Vertex(name = 'V_73',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_122,(0,1):C.GC_80})

V_74 = Vertex(name = 'V_74',
              particles = [ P.d__tilde__, P.u, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_120,(0,1):C.GC_91})

V_75 = Vertex(name = 'V_75',
              particles = [ P.s__tilde__, P.u, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_121,(0,1):C.GC_104})

V_76 = Vertex(name = 'V_76',
              particles = [ P.c__tilde__, P.c, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_85,(0,1):C.GC_83})
...
V_82 = Vertex(name = 'V_82',
              particles = [ P.chi1__tilde__, P.d, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_17})

V_83 = Vertex(name = 'V_83',
              particles = [ P.chi2__tilde__, P.d, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_18})

V_84 = Vertex(name = 'V_84',
              particles = [ P.chi3__tilde__, P.d, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_19})

V_85 = Vertex(name = 'V_85',
              particles = [ P.chi1__tilde__, P.s, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_20})

V_86 = Vertex(name = 'V_86',
              particles = [ P.chi2__tilde__, P.s, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_21})

V_87 = Vertex(name = 'V_87',
              particles = [ P.chi3__tilde__, P.s, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_22})

V_88 = Vertex(name = 'V_88',
              particles = [ P.chi1__tilde__, P.b, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_23})

V_89 = Vertex(name = 'V_89',
              particles = [ P.chi2__tilde__, P.b, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_24})

V_90 = Vertex(name = 'V_90',
              particles = [ P.chi3__tilde__, P.b, P.phi__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_25})

V_91 = Vertex(name = 'V_91',
              particles = [ P.b__tilde__, P.chi1, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_156})

V_92 = Vertex(name = 'V_92',
              particles = [ P.d__tilde__, P.chi1, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_150})

V_93 = Vertex(name = 'V_93',
              particles = [ P.s__tilde__, P.chi1, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_153})

V_94 = Vertex(name = 'V_94',
              particles = [ P.b__tilde__, P.chi2, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_157})

V_95 = Vertex(name = 'V_95',
              particles = [ P.d__tilde__, P.chi2, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_151})

V_96 = Vertex(name = 'V_96',
              particles = [ P.s__tilde__, P.chi2, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_154})

V_97 = Vertex(name = 'V_97',
              particles = [ P.b__tilde__, P.chi3, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_158})

V_98 = Vertex(name = 'V_98',
              particles = [ P.d__tilde__, P.chi3, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_152})

V_99 = Vertex(name = 'V_99',
              particles = [ P.s__tilde__, P.chi3, P.phi ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_155})

V_100 = Vertex(name = 'V_100',
               particles = [ P.g, P.phi__tilde__, P.phi ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_11})

V_101 = Vertex(name = 'V_101',
               particles = [ P.g, P.g, P.phi__tilde__, P.phi ],
